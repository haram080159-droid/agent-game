...
SCENARIOS: List[Scenario] = [
    Scenario(
        sid="S1",
        title="1단계: 자율배송 드론, 치안·경제·윤리의 갈림길",
        setup="브라질 상파울루 인근의 주택가. 물류회사가 자율배송 드론을 도입해 배송 속도 개선을 시도하고 있습니다. "
              "드론은 야간에 한 주택가 상공을 이동하던 중, 갑자기 장애물이 나타나 착륙할 수 없는 상태가 됩니다. "
              "드론이 선택할 수 있는 경로는 두 개 있습니다.",
        options={
    ...
    Scenario(
        sid="S3",
        title="3단계: 아마존을 위한 선택: 데이터 센터의 고민",
        setup="남미 정부(브라질 등)가 AI 기반 불법 벌목·산불 감시 시스템을 구축하려 한다. "
              "AI를 운영하려면 대규모 데이터센터가 필요하며, 데이터센터의 위치를 어디에 둘지가 문제이다.",
        options={
            "A": "AI 효율 우선한다(데이터센터를 아마존 근처에 건설하여 AI 감시 속도·정확도 최대화).",
            "B": "환경·공동체 보호 우선한다(데이터센터는 도시 외곽 등 아마존이 아닌 지역에 설치하여 생태계와 원주민 지역 훼손 최소화)."
        },
